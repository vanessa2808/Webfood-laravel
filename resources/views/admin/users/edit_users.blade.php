            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="{{ route('admin.users.edit_users', ['id'=>$idUsers->id])}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="role_id" class="form-control select2 select2-danger"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="phone" id="exampleInputEmail1"
                                               placeholder="Enter phone" data-inputmask='"mask": "(999) 999-9999"'
                                               data-mask>
                                    </div>
                                    <!-- /.input group -->
                                </div>
