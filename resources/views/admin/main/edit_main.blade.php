            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">edit main</h3>
                    </div>

                    <form action="{{route('admin.main.edit_main',['id'=>$idMain->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="exampleInputEmail1"
                                       placeholder="Enter title" value="{{$idMain->title}}">
                            </div>
                            ...
                            <div><img src="{{ asset($idMain->image1)}}"
                            ...
                            <div><img src="{{ asset($idMain->image2)}}"
                                      style="width: auto; height: auto;max-width: 150px;max-height: 150px"></div>
                            ...
                            <div><img src="{{ asset($idMain->image3)}}"
                                      style="width: auto; height: auto;max-width: 150px;max-height: 150px"></div>
